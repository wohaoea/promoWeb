    ...
    $.extend(Fullpage.prototype, {
        ...
        initEvent: function() {
            ...
            $this.on('touchstart', function(e) {
                ...
                var _X = null;
                var _Y = null;
                if( typeof constantX != 'undefined' )_X=constantX;
                if( typeof constantY != 'undefined' )_Y=constantY;
                that.startX = _X || e.targetTouches[0].pageX;
                that.startY = _Y || e.targetTouches[0].pageY;
            });
