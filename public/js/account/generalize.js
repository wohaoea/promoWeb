            ...
            success: function(msg) {
                if (msg.result == "fail") {
                    if (msg.errortype == "2") {
                        ...
                        var content = '<p>您的手机号码已注册牛呗app账号</p>'
                            +'<p>如是本人操作请下载牛呗app申请借款</p>'
                            +'<p>非本人操作请联系客服</p>'
            ...
            success: function(msg) {
                if (msg.result == "fail") {
                    ...
                    if( typeof wxInit != 'undefined' ){
                        shareLink = location.host + '/account/generalize?inviterId=' + $('#phonenum').val().trim();
                    }
                    var content = '<p style="margin-top: 0.5rem">您已获得千元借款额度</p>'
                                 +'<p>赶快下载牛呗APP申请借款吧</p>';
                    $('.shade').show();
