(function($) {
    ...
    $.fn.goToTop.def = {
        ...
        content:function(html){
            if(html)$(html).appendTo("body");
          
        }
    };
    //用法：
    //1.$(".right-nav").goToTop.def.content('<div class="right-nav"><a href="' + domain + 'invest" class="register"></a><a href="javascript:;" class="top"></a></div>');
    //2.$(".right-nav").floatright();//导航
